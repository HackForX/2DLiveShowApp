...
import '../helpers/string_enum.dart';
import 'api_exceptions.dart';

class BaseClient {
  static final Dio _dio = Dio();
  static const Duration TIME_OUT_DURATION = Duration(milliseconds: 5000); // in milliseconds
  ...
  static download(
    ...
    try {
      await _dio.download(
        url,
        savePath,
        options: Options(receiveTimeout: TIME_OUT_DURATION, sendTimeout: TIME_OUT_DURATION),
        onReceiveProgress: onReceiveProgress,
      );
      onSuccess();
    } catch (error) {
